...
import '../../../asset/css/cart/cartHeader.css';
import {
    HOME_PAGE,
    LOGIN_PAGE,
...
import {getUsername, getUser, getSellerId} from "../../../service/userService";
                ...
                <div className="grid wide">
                        ...
                        <ul className="header__navbar-list">
                            {getSellerId() !== null
                                ? <li className="header__navbar-item">
                                    <Link to={PRODUCT_MANAGEMENT_PAGE}
                    ...
                    <div className="header-with-search">
                        ...
                        <div className= "hide-on-tablet">
                            <Link to={HOME_PAGE} className="eader__logo-link__cartline">
                                <LogoCogy/>
                            </Link>
                        </div>
                        <p className="header__letter">{props.pageDescription}</p>
                        <input type="checkbox" hidden id="mobile-search-checkbox" className="mobile-search-checkbox" />
                        <div className="header__search__cartheader">
