...
import com.cogy_ecommerce_service.security.JwtAuthEntryPoint;
import com.cogy_ecommerce_service.security.JwtAuthFilter;
import com.cogy_ecommerce_service.service.impl.UserDetailsServiceImpl;
...
public class SecurityConfiguration  {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests() // links start with /api/
                .antMatchers("/api/home", "/api/login", "/api/checking/","api/register", "/api/mock-up-data") // perform segregate authorize
                .permitAll();
