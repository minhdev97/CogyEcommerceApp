...
public class ServiceLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.service.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.service.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.service.*.*(..))", throwing = "error")
