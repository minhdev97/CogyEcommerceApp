...
public class ConfigLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.configuration.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.configuration.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.configuration.*.*(..))", throwing = "error")
