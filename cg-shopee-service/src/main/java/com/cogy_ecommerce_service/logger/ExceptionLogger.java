...
public class ExceptionLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.exception.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.exception.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.exception.*.*(..))", throwing = "error")
