...
public class UtilsLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.utils.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.utils.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.utils.*.*(..))", throwing = "error")
