...
public class ControllerLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.controller.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.controller.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.controller.*.*(..))", throwing = "error")
