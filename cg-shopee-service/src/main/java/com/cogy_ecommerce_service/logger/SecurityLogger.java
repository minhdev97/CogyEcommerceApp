...
public class SecurityLogger {
    ...
    @Before("execution(public * com.cogy_ecommerce_service.security.*.*(..))")
    ...
    @After("execution(public * com.cogy_ecommerce_service.security.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.cogy_ecommerce_service.security.*.*(..))", throwing = "error")
